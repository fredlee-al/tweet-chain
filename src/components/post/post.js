...
const Post = (props) => {
  ...
  const sendComment = () => {
    ...
    let url = `https://tweet-8qqa.onrender.com/${props.post_id.$oid}/comments`;
    axios({
      method: "post",
      url: url,
      data: data,
  ...
  const likePost = () => {
    setLiked(!liked);
    let url = `https://tweet-test-yin.herokuapp.com/${props.post_id.$oid}/like`;
    axios({
      method: "get",
      url: url,
      headers: {
  ...
  const retweetPost = () => {
    ...
    let url = `https://tweet-test-yin.herokuapp.com/${props.post_id.$oid}/retweet`;
    axios({
      method: "get",
      url: url,
      headers: {
  ...
  const bookmarkPost = () => {
    setSaved(!saved);
    let url = `https://tweet-test-yin.herokuapp.com/${props.post_id.$oid}/bookmark`;
    axios({
      method: "get",
      url: url,
      headers: {
  ...
  return (
    <article className="post">
      {commentSent === false ? (
        <p className="tweetFail">AError!!</p>
      ) : null}
